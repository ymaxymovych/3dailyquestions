...
import { Calendar, Briefcase, ExternalLink, Plug, AlertCircle, HardDrive, Github, LayoutList, ChevronDown, ChevronRight, GripVertical, Plus, Copy, Check } from 'lucide-react';
