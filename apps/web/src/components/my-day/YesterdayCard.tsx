            ...
            <div className="p-5 space-y-6">
                ...
                <section>
                    <div className="flex items-center justify-between mb-3">
                        ...
                        <button
                            onClick={onAddTask}
                            className="flex items-center gap-1 text-[10px] font-medium text-blue-600 hover:text-blue-700 dark:text-blue-400 dark:hover:text-blue-300 transition-colors"
                        >
                    ...
                    <section>
                        ...
                        <div className="relative h-full">
                            <textarea
                                ...
                                placeholder="Екстрений фікс (30 хв)..."
                            />
                        </div>
                    </section>
